...
export type DiscountPolicyDTO = CompositeDiscountPolicyDTO | SimpleDiscountPolicyDTO | EarlyBirdDiscountPolicyDTO | LastMinuteDiscountPolicyDTO | MinimumPurchaseDiscountPolicyDTO | MaximumPurchaseDiscountPolicyDTO | CouponCodeDiscountPolicyDTO;
