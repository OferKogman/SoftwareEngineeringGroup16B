...
export type MinTicketsPerCustomerPurchasePolicyDTO = DefaultPurchasePolicyDTO & {
    type : "Minimum Tickets Per Customer";
    minTickets: number;
};

export type MaxTicketsPerCustomerPurchasePolicyDTO = DefaultPurchasePolicyDTO & {
...
export type PurchasePolicyDTO = CompositePurchasePolicyDTO | MinAgePurchasePolicyDTO | MaxAgePurchasePolicyDTO | MinTicketsPerCustomerPurchasePolicyDTO | MaxTicketsPerCustomerPurchasePolicyDTO | LotteryPurchasePolicyDTO;
