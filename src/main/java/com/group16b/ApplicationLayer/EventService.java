...
public class EventService {
	...
	public EventService(IAuthenticationService authenticationService, IUserRepository userRepository,
			IVenueRepository venueRepository, IEventRepository eventRepository) {
