...
public class ReserveService {
    ...
    private double calculateDiscountPolicies(int eventID, double pricePerSeat, int amount) {
        ...
        for (DiscountPolicy dp : allPolicies) {
            priceAfterDiscountPolicy = dp.calculateDiscount(priceAfterDiscountPolicy, new DiscountContext(10, amount, LocalDateTime.now(), null));
        }
