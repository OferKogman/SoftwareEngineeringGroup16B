...
public class LastMinuteDiscountDTO extends DiscountPolicyDTO {
    ...
    public LocalDateTime getLastMinuteStartDate() { return lastMinuteStartDate; }
    public void setLastMinuteStartDate(LocalDateTime lastMinuteStartDate) { this.lastMinuteStartDate = lastMinuteStartDate; }
}