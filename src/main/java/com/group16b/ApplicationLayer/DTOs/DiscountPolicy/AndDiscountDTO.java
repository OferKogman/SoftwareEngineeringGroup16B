...
public class AndDiscountDTO extends DiscountPolicyDTO {
    private DiscountPolicyDTO left;
    private DiscountPolicyDTO right;
    private double percentage;

    public AndDiscountDTO(DiscountPolicyDTO left, DiscountPolicyDTO right, double percentage) {
        super(DiscountPolicyTypes.AND);
        this.left = left;
        this.right = right;
