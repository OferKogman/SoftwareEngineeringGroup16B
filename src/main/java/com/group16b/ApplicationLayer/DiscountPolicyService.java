...
public class DiscountPolicyService {
    ...
    public Result<Boolean> createCompanyDiscountPolicy(
        ...
        try {
            ...
            if (!company.getDiscountPolicy().isEmpty()) {
                throw new IllegalStateException(
                        "Production company already has a discount policy.");
            }
    ...
    public Result<Boolean> createEventDiscountPolicy(
            String sessionToken,
            int eventID,
            DiscountPolicyRecord record) {
        ...
        try {
            ...
            if (!event.getEventDiscountPolicy().isEmpty()) {
                throw new IllegalStateException(
                        "Event already has a discount policy.");
            }
    ...
    public Result<Boolean> editCompanyDiscountPolicy(
            String sessionToken,
            int companyID,
        ...
        try {
            ...
            Set<DiscountPolicy> currentPolicies =
                    company.getDiscountPolicy();

            for (DiscountPolicy policy : currentPolicies) {
                company.removeDiscountPolicy(policy);
            }

            if (newRecord != null) {
                company.addDiscountPolicy(
                        buildPolicy(newRecord));
            }
            ...
            logger.error(
                    "DiscountPolicyService.editCompanyDiscountPolicy: {}",
                    e.getMessage());
    ...
    public Result<Boolean> editEventDiscountPolicy(
            String sessionToken,
            int eventID,
            DiscountPolicyRecord newRecord) {
        ...
        try {
            ...
            for (DiscountPolicy policy : currentPolicies) {
                event.removeEventDiscountPolicy(policy);
            }

            if (newRecord != null) {
                event.addEventDiscountPolicy(
                        buildPolicy(newRecord));
            }
            ...
            logger.error(
                    "DiscountPolicyService.editEventDiscountPolicy: {}",
                    e.getMessage());
