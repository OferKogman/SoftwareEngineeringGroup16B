...
public class DiscountPolicyService {
    ...
    // to verify the identity of the caller, use something similar to
    // companyHierarchyService.isOwner
    // there it extracts the data from RequestContext, that includes the subjectID
    // and its role
    // if you want sessionToken, add it here, and in the controller ethod found in
    // EventDiscountPolicyController
