...
public class AndDiscount implements DiscountPolicy {
    ...
    public AndDiscount(DiscountPolicy left, DiscountPolicy right, double discountPercentage) {
        if (left == null || right == null)
            throw new IllegalArgumentException("AndDiscount must have both left and right children.");
