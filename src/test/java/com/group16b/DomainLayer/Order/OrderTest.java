...
class OrderTest {
	...
	void seatOrderGetSeatsReturnsSeats() {
		...
		Order order = new Order("order1", "segment1", seats);
	...
	void fieldOrderGetSeatsThrowsException() {
		// Arrange
		Order order = new Order("order1", "segment1", 3);
	...
	void completeOrderChangesStateToCompletedOrder() {
		// Arrange
		Order order = new Order("order1", "segment1", List.of("A1", "A2"));
	...
	void seatOrderNumOfTicketsEqualsNumberOfSeats() {
		// Arrange
		Order order = new Order("order1", "segment1", List.of("A1", "A2", "A3"));
	...
	void fieldOrderNumOfTicketsEqualsRequestedAmount() {
		// Arrange
		Order order = new Order("order1", "segment1", 5);
